...
_Setup_ phase is the first phase in task lifecycle. _Setup_ comes at the point where you need to show task description; at this phase preconditions, description and rewards are computed. The main mechanism in WTF by which you can do that is a Macro.
