...
In this tutorial, we'll go through creation of a simple quest using Weird Task Framework. I will not touch advanced topics; for that, head to [Documentation](/documentation/intro). Let's get started.
